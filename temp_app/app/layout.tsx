        ...
        <ThemeProvider>
          <NotificationProvider>
            <div className="fixed inset-0 -z-10 bg-space">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-white/85 via-white/70 to-white/85 dark:from-slate-900/90 dark:via-slate-900/70 dark:to-slate-900/90"></div>
