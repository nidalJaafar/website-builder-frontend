      ...
      <div>
          <section className="grid sm:grid-cols-3 gap-3">
              ...
              <div className="rounded-xl bg-slate-900/60 ring-1 ring-white/10 p-4">
                  ...
                  <p className="text-sm text-slate-400">
                      Create a site preview &amp; export.
                  </p>
              </div>
          </section>
    <footer className="border-t border-white/10 py-8" id="help">
        <div className="grid sm:grid-cols-3 gap-6 text-sm text-slate-400">
            ...
            <div>
                <p className="font-semibold text-white">Shortcuts</p>
                <ul className="mt-2 space-y-1 list-disc list-inside">
                    <li>⌘/Ctrl + Enter — Generate Prompt</li>
                    <li>⌘/Ctrl + ⇧ + G — Generate Website</li>
                    <li>⌘/Ctrl + B — Toggle Advanced</li>
                </ul>
            </div>
            <div>
